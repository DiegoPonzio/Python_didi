...
CREATE TABLE `alumnobatiz` (
  ...
  KEY `nombre` (`nombre`),
  KEY `appat` (`appat`)
) ENGINE=InnoDB AUTO_INCREMENT=2021090216 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `alumnobatiz` VALUES (20210506,'Oziel','Martinez','Alvarez','5583619521'),(20210548,'Jorge','Perez','De la Rosa','5523272080'),(2021090214,'Diego','Ruiz','Ponzio','5582322001'),(2021090215,'Diana','Castillo','Cardenas',NULL);
...
-- Dump completed on 2022-05-06 10:09:19
